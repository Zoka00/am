...
if photo.total_count > 0 then
local TestText = "*◍︙Oꪝꪀᥱℛ Gℛ᥆ᥙρ ↬ *  ["..Jabwa.first_name.."](tg://user?id="..Jabwa.id..")\n*◍︙B𝑖𝑜 ↬ * [{ "..Bio.." }]"
keyboardd = {} 
...
if photo.total_count > 0 then
local TestText = "* ◍︙H𝑒𝑟𝑒 𝑖𝑠 𝑡ℎ𝑒 𝑑𝑒𝑣 𝑏𝑜𝑡*\n*◍︙Nᥲ️꧑ᥱ ↬*  ["..Jabwa.first_name.."](tg://user?id="..Sudo_Id..")\n*◍︙B𝑖𝑜 ↬ * ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..Jabwa.username..""},
...
local abnj = " \n*◍︙Nᥲ️꧑ᥱ ↬ * "..Jabwayt.result.first_name.." \n"
keyJabwayt = {} 
