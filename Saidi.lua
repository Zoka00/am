...
ControllerAll = false
local ListSudos ={Sudo_Id,1614314857,5001240649,5185547990}  
...
Status = 'مطور السورس'
elseif UserId == 5001240649 then  
Status = 'المبرمج احمد المصري'
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5001240649 then
msg.Name_Controller = 'المبرمج احمد المصري'
msg.The_Controller = 1
...
local N = (Redis:get(Saidi.."Name:Bot") or "ماندو")
...
{
{text = '◍ ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ 🇫🇮', url = 't.me/manfo765'}, 
},
}
...
{
{text = 'ᯓ ѕᴏᴜʀᴄᴇ ᴍᴀɴᴅᴏ', url='https://t.me/manfo765'},
},
}
}
...
if text == 'رفع نسخه ماندو' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ ⋮  هاذا الامر يخص{ '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'◍ ⋮  تم استرجاع المجموعات من نسخه ماندو')
else
...
--download('https://raw.githubusercontent.com/zoka00/ma/master/Saidi.lua','Saidi.lua')
...
NamesBot = (Redis:get(Saidi.."Name:Bot") or "ماندو")
...
local Texting = {'●○━━━━ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ━━━━○●',"●○━━━━ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ━━━━○● ","●○━━━━ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ━━━━○●","●○━━━━ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ━━━━○●","●○━━━━ᴛᴇᴀᴍ ᴍᴀɴᴅᴏ━━━━○●",}
...
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local news = 'B𝑖𝑜 ← '..getbio(msg.sender.user_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =news,url = "https://t.me/"..Jabwa.username..""}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, news, 'md', false, false, false, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'ᯓ ѕᴏᴜʀᴄᴇ ᴍᴀɴᴅᴏ', url = "http://t.me/manfo765"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◍ ⋮  عذرا لا تستطيع استخدام الامر على المطور ماندو *","md",true)  
end
if UserId == "5001240649" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◍ ⋮  عذرا لا تستطيع استخدام الامر على المبرمج احمد المصري *","md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'اضغط لاضافه ألبوت لمجموعتك 𖠪', url = 't.me/'..UserBot..'?startgroup=new'}
},
}
local msgg = msg_id/2097152/0.5
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @manfo765"..Creator.."\n"
else
...
data = {
{
{text = 'ᯓ ѕᴏᴜʀᴄᴇ ᴍᴀɴᴅᴏ', url = 't.me/manfo765'}, 
},
}
}
...
if text == "بنك" or text == "البنك" or text == "بنكي" or text == "bank" then
local Jabwa = LuaTele.getUser(Sudo_Id) 
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "تربو")
local t = "*مرحبا بك في بنك تربو*"
local m = "https://t.me/zo0k2/13"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '« sᴏᴜʀᴄᴇ ᴛᴜʀʙᴏ »', url = "http://t.me/AHTURB"}
},
{
{text =news, url = "https://t.me/"..Jabwa.username..""},
},
...
if not Redis:get(Saidi.."mymaryam:status"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*◍ ⋮ لعبة مريم معطله*","md",true)
end 
local t = "*مرحبا بك في بنك تربو*"
local m = "https://t.me/zo0k2/13"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '« اوامر البنك »', callback_data=msg.sender.user_id.."/roma"},
},
{
{text = '« sᴏᴜʀᴄᴇ ᴛᴜʀʙᴏ »', url = "http://t.me/AHTURB"}
},
...
local user_info = LuaTele.getUser(msg.chat.user.id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "https://t.me/zo0k2/13"
local Name = 'مرحبا بك في بنك تربو*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '« اوامر البنك »', callback_data=msg.sender.user_id.."/roma"},
...
elseif text == 'احمد' or text == 'احمد المصري' or text == 'مبرمج السورس' then
photo = "https://t.me/DEV_AH8"
local Name = '* ╭───── •𖥔• ─────╮\n*𖥔 [‹الاسم➧ احمد المصري›](t.me/DEV_AH8)*\n*𖥔 [‹العمر ➧ 23›](t.me/DEV_AH8)*\n*𖥔 [‹السكن ➧ القاهره/ حلوان›](t.me/DEV_AH8)*\n*𖥔 [‹الرتبه ➧ مبرمج سورسات›](t.me/DEV_AH8)*\n╰───── • 𖥔 • ─────╯\n𝐃𝐚𝐝 𝐀𝐡𝐦𝐞𝐝 𝐀𝐥𝐦𝐬𝐫𝐲 ➪*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• 𝐃𝐚𝐝 𝐀𝐡𝐦𝐞𝐝 𝐀𝐥𝐦𝐬𝐫𝐲 ➪🇫🇮•', url = "https://t.me/DEV_AH8"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'ماندو' or text == 'المطور ماندو' or text == 'مطور السورس' then
photo = "https://t.me/Mandi778"
local Name = '*المطور ماندو مطور السورس لو حاابب تتواصل معاه بالاسفل ⚶*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝗱𝗲𝘃 𝗺𝗮𝗻𝗱𝗼 𝅘𝅥𝅯 ', url = "https://t.me/Mandi778"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = 'قناه السورس', url = "http://t.me/manfo765"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
{
{text = 'قناه السورس', url = 't.me/manfo765'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'◍ ⋮  اليك قسم الالعاب من سورس ماندو ',"md",false, false, false, false, reply_markup)
end
if Text and Text:match('(%d+)/roma') then
local UserId = Text:match('(%d+)/roma')
if tonumber(IdUser) == tonumber(UserId) then
local bain = LuaTele.getUser(IdUser)
local txxt = [[*
❰مرحبا بك في اوامر بنك تربو ❱
《━━ѕᴏᴜʀᴄᴇ ᴛᴜʀʙᴏ━━》

〖 انشاء حساب بنكي ⇇ تقدار تفتح حساب وتحول فلوس مع مازيا اخري〗

〖 مسح حساب بنكي ⇇تالغي حسابك البنكي〗
...
〖 بخشيش/ بقشيش ⥢ يعطيك بخشيش كل ١٠ دقايق 〗
...
keyboard.inline_keyboard = {
{
{text = '« تحكم العاب التسليه »', callback_data=IdUser.."/opensly"},
},
{
{text = ' ❰ 𝟏 ❱', callback_data=IdUser.."/help1"},{text = ' ❰ 𝟐 ❱', callback_data=IdUser.."/help2"},
},
{
{text = ' ❰ 𝟑 ❱', callback_data=IdUser.."/help3"},{text = ' ❰ 𝟒 ❱', callback_data=IdUser.."/help4"},
},
{
{text = ' ❰ 𝟓 ❱', callback_data=IdUser.."/listallAddorrem"},{text = ' ❰ 𝟔 ❱', callback_data=IdUser.."/Settings"},
},
{
{text = ' ❰ 𝟕 ❱', callback_data=IdUser.."/roma"},
},
{
{text = '« القائمه الرئيسيه »', callback_data=IdUser.."/helpall"},
},
{
...
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴍᴀɴᴅᴏ •𓄹', url = "http://t.me/manfo765"}
},
}
local rep = msg.id/2097152/0.5
...
local NamesBot = (Redis:get(Saidi.."Name:Bot") or "ماندو")
local BotName = {
'• مرحبا انا '..NamesBot..'',
}
...
if text == (Redis:get(Saidi.."Name:Bot") or "ماندو") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local Jabwa = LuaTele.getUser(Saidi)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "ماندو")
local BotName = {
'نعم يروحي',
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ماندو').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ ⋮  هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)  
end
...
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "ماندو")
local Jabwa = LuaTele.getUser(Saidi)
local bain = LuaTele.getUser(msg.sender.user_id)
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Saidi..'Channel:Join')}, },}}
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(various.."Name:Bot") or "ڤاريوس")..
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس ماندو اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس ماندو 
